...
public class Formulario2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbDistrito.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lince", "Surco", "Barranco", "San_Borja", "San_Isidro", "Miraflores", "Pueblo_Libre", "Jesús_María", "Magdalena", "San_Miguel" }));
        cbDistrito.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void cbDistritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbDistritoActionPerformed
        ...
        cbDistrito.removeAllItems();
            /*hacemos un for mejorado para utilizar p*/
